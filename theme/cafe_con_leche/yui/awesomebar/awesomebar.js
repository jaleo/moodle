YUI.add('moodle-theme_cafe_con_leche-awesomebar', function(Y) {
...
AwesomeBar.prototype = {
    ...
    initializer : function(config) {
        Y.all('.cafe_con_leche-awesome-bar ul.dropdown li > span').each(this.enhanceAwesomeBar, this);
        Y.all('.cafe_con_leche-awesome-bar ul.dropdown li.clickable-with-children > a').each(this.enhanceAwesomeBar, this);
    },
...
Y.extend(AwesomeBar, Y.Base, AwesomeBar.prototype, {
    NAME : 'Café con Leche theme AwesomeBar enhancer',
    ATTRS : {
...
M.theme_cafe_con_leche.initAwesomeBar = function(cfg) {
